...
public class P03_Apple_task
{
    public static void main(String[] args) throws InterruptedException {
        ...
        // Storing 9 web elements including "apple" logo and search button
        List<WebElement> headerLinks = driver.findElements(By.xpath("//ul[@class='ac-gn-list']//li/a"));

        // en sondaki ve enbastaki almak istemedigimiz icin 1 den baslayip en sona gitmedim
        ...
        for (int eachLink= 1; eachLink<headerLinks.size()-1; eachLink++) {
            ...
            // body //a return all links inside of my body
